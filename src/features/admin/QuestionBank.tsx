      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <select
            ...
            className="px-4 py-2 rounded-lg border bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-primary-500"
          >
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal} title={modalMode === 'add' ? 'افزودن سوال جدید' : 'ویرایش سوال'} size="2xl">
            <form onSubmit={handleFormSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label htmlFor="category" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">دسته بندی</label>
                    <select
                      id="category"
                      name="category"
