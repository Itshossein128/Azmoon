...
const mockQuestions = [
  { id: '1', text: 'React Question', category: 'React', type: 'multiple-choice', options: ['A', 'B', 'C', 'D'], correctAnswer: 0, points: 5, examId: '1' },
  { id: '2', text: 'Vue Question', category: 'Vue', type: 'multiple-choice', options: ['A', 'B', 'C', 'D'], correctAnswer: 1, points: 5, examId: '1' },
];
